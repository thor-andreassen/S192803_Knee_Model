...
output_data={'TCS_to_FCS_TransMat':TCS_to_FCS_TransMat,'gskin':gskin,'Times':times,'GCS_to_FCS_TransMat':GCS_to_FCS_TransMat,'GCS_to_TCS_TransMat':GCS_to_TCS_TransMat}
fname = filename+"TransMat.mat"
